...
def train_using_LM(Pij,s,img_dict):
    ...
    while ((not stop) and (k < max_iter)):
        ...
        if (k==5):
            rd.render(Pij, s, img_dict, cfg.prefix_name+"train_onlyOT_5.png",colored_picPath=cfg.prefix_name+"train_onlyOT_5_colored.png")
        elif (k==30):
            rd.render(Pij, s, img_dict, cfg.prefix_name+"train_onlyOT_30.png",colored_picPath=cfg.prefix_name+"train_onlyOT_30_colored.png")
            uf.saveToDict({"Pij": Pij, "M": cfg.M, "N": cfg.N},cfg.createDictName("train_onlyOT_30"))
        ...
        if (k > 1 and (abs(loss-last_loss) < 1e-16 or stop or k == max_iter-1)):
            ...
            if (using_varyweight_flag == True):
                ...
                rd.render(Pij, s, img_dict, cfg.prefix_name+"train_onlyOT_1st.png",colored_picPath=cfg.prefix_name+"train_onlyOT_1st_colored.png")
                uf.saveToDict({"Pij": Pij, "M": cfg.M, "N": cfg.N},cfg.createDictName("train_onlyOT_1st"))
